...
export const CardGrade = ({ item, setList, list, idx, handleAddCard }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
            ...
            {!isCreated ? (
              ...
              <>
                <Box
                  ...
                  onMouseDown={isEditing ? handleSubmit(onSubmit) : () => setIsEditing(true)}
                >
                  {isEditing ? (
                    <SaveIcon onMouseDown={handleSubmit(onSubmit)} />
                  ) : (
                    <EditIcon style={{ color: 'white' }} onMouseDown={() => setIsEditing(true)} />
                  )}
                </Box>
                <Box
                  style={{
